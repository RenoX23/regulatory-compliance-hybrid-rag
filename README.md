...
> 🌐 **Live Interactive Auditor Demo**: [renox23-regulatory-compliance-hybrid-rag.streamlit.app](https://renox23-regulatory-compliance-hybrid-rag.streamlit.app/)
...
## Visual Interface & Application Walkthrough

### 1. Interactive Regulatory Compliance Query & Verified Determination
Auditors can input complex statutory inquiries. The system performs hybrid retrieval, cross-attention reranking, confidence scoring, and citation verification with millisecond latency breakdowns.

![Compliance Audit Query](screenshots/demo_audit_query.png)

### 2. Verified Statutory Citations, Latency Waterfall & Source Inspector
Every output provides authoritative circular references `[Doc ID, Section, Page #]`, a pipeline latency waterfall (Dense, Sparse, RRF, Cross-Encoder, Generation), and inspectable source passages with relevance scores.

![Verified Citations & Latency Waterfall](screenshots/demo_citations_waterfall.png)

### 3. Quantitative Ragas-Aligned Benchmark Dashboard
Evaluated against 105 auditor-grade compliance inquiries across exact legal codes, quantitative ratios, governance mandates, and out-of-scope adversarial prompts.

![Ragas Benchmark Dashboard](screenshots/demo_ragas_benchmarks.png)

### 4. Audited Regulatory Corpus Manifest
Browse the 22 authentic Master Directions, circulars, and statutes compiled under PyMuPDF with structured section tags and circular references.

![Regulatory Corpus Manifest](screenshots/demo_corpus_manifest.png)
...
├── screenshots/                    # UI demo walkthrough assets
├── src/
